...
all_re_input <- rbind(
  ww_re_input_data %>% 
    ...
    select(data_type, influenza_type, date, observation_type, observation, is_observation),
...
estimated_incidence_plot <- ggplot(
  data = all_re_clean %>% 
    ...
    filter(delay_dist != "Fecal"),  # use resp delay dist
...
ggsave("figures/re_comparision_focus.png", width = 6.5, height = 2.75, units = "in")
```
