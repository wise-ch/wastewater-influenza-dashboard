...
#' @return Data frame with columns: region, pathogen_type, data_type, date, median_R_mean, median_R_highHPD, median_R_lowHPD
load_covid_cantonal_cases_re <- function(
    url_to_data = "https://raw.githubusercontent.com/covid-19-Re/dailyRe-Data/master/CHE-estimates.csv"
) {
  ...
  covid_cantonal_re <- covid_cantonal_re %>% filter(estimate_type == 'Cori_slidingWindow',
